...
public class GroundRouter {
	...
	static {
		GroundRouter.loadInAllZipcodes();
		GroundRouter.loadInAllCenters();
	}

	public static void loadInAllCenters() {
		GroundRouter.statesToDistributionCenters = new HashMap<String, DistributionCenter>();
	...
	private static void loadInAllZipcodes() {
	...
	public static DistributionCenter groundLocationLookup(String zipcode) throws JitsException {
